...
const authMiddleware = requir("../middlewares/authMiddleware.js");
// Implémenter le controller
const bannedControllers = require("../controllers/bannedControllers");

// router.get("/:id"); // Récupérer tous les ingrédients bannis d'un utilisateur si admin ou utilisateur connecté
